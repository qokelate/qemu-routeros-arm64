...
-netdev "tap,ifname=ros-lan1,id=n1,$netopt" -device "virtio-net-pci,netdev=n1,mac=d2:67:e2:11:11:11,$drvopt" \
-netdev "tap,ifname=ros-lan2,id=n2,$netopt" -device "virtio-net-pci,netdev=n2,mac=d2:67:e2:22:22:22,$drvopt" \
-netdev "tap,ifname=ros-wan,id=n3,$netopt" -device "virtio-net-pci,netdev=n3,mac=d2:67:e2:33:33:33,$drvopt" \
-netdev "tap,ifname=ros-kvm,id=n4,$netopt" -device "virtio-net-pci,netdev=n4,mac=d2:67:e2:44:44:44,$drvopt" \
